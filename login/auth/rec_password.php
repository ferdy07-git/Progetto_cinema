...
<head>
    ...
    <title>Recupera password — Cinema Palladino</title>
</head>
<body>
<div class="auth-page">
    ...
    <form class="auth-panel" action="recuperaPassword.php" method="post">
        ...
        <div class="auth-field">
            ...
            <div class="pass-wrapper">
                ...
                <button type="button" class="toggle-pass" aria-label="Mostra conferma password" data-target="conferma_pass">
                    <i class="ti ti-eye" aria-hidden="true"></i>
                </button>
            </div>
...
<script>
    ...
    if (params.get("errore") === "credenziali") {
        const messaggio = document.createElement("div");
        messaggio.innerHTML = "<div style='text-align:center; color:red;'>Registrazione non riuscita</div>";

        const pulsanti = document.querySelector(".auth-actions");
        pulsanti.parentNode.insertBefore(messaggio, pulsanti);
    }

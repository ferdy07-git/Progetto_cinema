...
(2, 5, 'Hopper - Il segreto della marmotta', 'Hopper, una marmotta curiosa e coraggiosa, scopre un antico segreto nascosto nelle montagne che potrebbe salvare la sua colonia da un inverno senza fine. Un''avventura animata piena di cuore.', '1h 35m', 'hopper_il_segreto_della_marmotta.webp'),
...
(4, 4, 'The Mandalorian and Grogu', 'Din Djarin e Grogu continuano il loro viaggio nella Galassia Lontana, Lontana. Mentre Grogu inizia ad addestrarsi nei modi della Forza, una nuova minaccia imperiale emerge dalle ombre, costringendo il Mandaloriano a scegliere tra il suo credo e il destino del bambino.', '2h 10m', 'the_mandalorian_and_grogu.webp'),
(5, 2, 'Michael', 'La storia biografica definitiva di Michael Jackson, che esplora la sua ascesa stellare, il suo genio artistico e le complesse vicende personali che hanno definito l''icona della musica pop, dalla giovinezza agli ultimi anni.', '2h 30m', 'micheal.webp'),
(6, 1, 'Il diavolo veste Prada 2', 'Anni dopo gli eventi del primo film, Andy Sachs, ora una redattrice di successo, deve tornare nel mondo della alta moda quando Miranda Priestly le chiede un favore impossibile, rimettendo in gioco vecchie rivalità e nuove ambizioni.', '1h 55m', 'il_diavolo_veste_prada_2.webp'),
...
(9, 3, 'Obsession', 'Uno psicoterapeuta di successo diventa ossessionato da un paziente misterioso che sembra conoscere i dettagli più oscuri del suo passato. La linea tra cura e follia si assottiglia pericolosamente.', '1h 52m', 'obsession.webp'),
(10, 3, 'Passenger', 'Su un volo transatlantico, un passeggero solitario nota comportamenti strani nell''equipaggio. Quando inizia a indagare, scopre che il velivolo non sta andando dove dovrebbe, e nessuno a bordo è chi dice di essere.', '1h 40m', 'passenger.webp'),
...
(12, 6, 'La Mummia', 'Un nuovo archeologo risveglia accidentalmente un''antica principessa maledetta nel deserto egiziano. Ora deve fermare la sua marcia di distruzione globale prima che l''oscurità inghiotta il mondo moderno.', '2h 12m', 'la_mummia.webp'),
(13, 10, 'Kill Bill: The Whole Bloody Affair', 'La versione integrale e senza censure della saga di vendetta della Sposa. Beatrix Kiddo affronta la Vipera Assassina e Bill in una sequenza di combattimenti stilizzati e brutali che ridefiniscono il cinema d''azione.', '2h 50m', 'kill_bill_the_whole_bloody_affair.webp');
...
(1, 1, 1, '2026-06-24', '18:00:00'),
(2, 2, 2, '2026-06-14', '20:00:00'),
(3, 3, 1, '2026-07-11', '19:30:00'),
(4, 4, 2, '2026-06-07', '21:30:00'),
(5, 5, 1, '2026-07-06', '20:15:00'),
(6, 6, 2, '2026-06-26', '17:00:00'),
(7, 7, 1, '2026-06-27', '20:00:00'),
(8, 8, 2, '2026-06-17', '18:30:00'),
(9, 9, 1, '2026-05-31', '16:00:00'),
(10, 10, 2, '2026-05-28', '21:00:00'),
(11, 11, 1, '2026-05-28', '19:00:00'),
